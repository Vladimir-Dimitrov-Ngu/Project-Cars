...
wandb.init(config=config, project="Car-project", name="baseline")
...
def main():
    ...
    train_dataset = StanfordCars('StanfordCars/train', split='train', transform=transform, download=False)
    test_dataset = StanfordCars('.StanfordCars/test', split='test', transform=transform, download=False)
